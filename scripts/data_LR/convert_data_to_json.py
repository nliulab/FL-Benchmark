...
folders = [folder for folder in os.listdir('../../data/simulated') if os.path.isdir(os.path.join('../../data/simulated', folder))]

for folder_name in folders:
    data_path = os.path.join('../../data/simulated', folder_name)
