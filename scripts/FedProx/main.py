...
def read_options():
    ...
    parser.add_argument('--folder',
                        help='the folder currently working on',
                        type=str,
                        default='homogenous')
    parser.add_argument('--folderSeed',
                        help='the seed folder currently working on',
                        type=str,
                        default='p_8.s_6.K_3_seed1')
...
def main():
    ...
    # read data
    train_path = os.path.join('data', options['dataset'], options['folder'], 'train_seed' + options['folderSeed'])
    test_path = os.path.join('data', options['dataset'], options['folder'], 'test_seed' + options['folderSeed'])
